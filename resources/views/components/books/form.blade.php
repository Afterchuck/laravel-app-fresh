<div class="space-y-6">
    ...
    <div class="grid gap-6 md:grid-cols-3">
        <div>
            ...
            @endphp
            <select name="genre" class="w-full rounded-lg border border-slate-100 px-4 py-3 focus:border-slate-900 focus:outline-none">
    ...
    <div class="grid gap-6 md:grid-cols-3">
        ...
        <div>
            ...
            <input type="file" name="cover_image" accept="image/*" class="block w-full rounded-lg border border-slate-300 bg-indigo-500 px-3 py-2 text-sm text-slate-700 focus:border-slate-900 focus:outline-none" />
