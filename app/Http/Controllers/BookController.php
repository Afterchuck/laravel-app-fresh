...
class BookController extends Controller
{
    ...
    // We use fill() or create() - make sure these are in $fillable in your Model!
    $data = $request->all();

    // Handle the image upload
    if ($request->hasFile('cover_image')) {
        // This stores the file in storage/app/public/covers
    ...
    {
        //
        return view('components.books.show', compact('book'));
    }
    ...
    public function edit(Book $book)
    {
        ...
        return view('components.books.edit', compact('book', 'genres'));
    }
